...
foreach ($object as $value) {?>
  ...
  <tr>
<td class="text-left text-center"><?php echo(rand(100000,299999)); echo $value->getId(); ?></td>
<td class="text-left text-center"><?php echo $value->getName(); ?></td>
<td class="text-left text-center"><?php echo $value->getAmount(); ?> €</td>
...
foreach ($object as $value) {?>
  <tbody class="table-hover">
  <tr>
<td class="text-left text-center"><?php echo $value->getName() . " " . $value->getAmount(); ?> €</td>
<td class="text-left text-center">
